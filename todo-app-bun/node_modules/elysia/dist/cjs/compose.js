...
exports.composeErrorHandler = exports.composeGeneralHandler = exports.composeHandler = exports.isAsync = exports.hasTransform = exports.hasType = exports.isFnUse = exports.hasReturn = void 0;
...
const composeHandler = ({ path, method, hooks, validator, handler, handleError, definitions, schema, onRequest, config, reporter }) => {
    ...
    const lifeCycleLiteral = validator || (method !== 'GET' && method !== 'HEAD')
        ...
        : [];
    const hasBody = hasUnknownContext ||
        (method !== 'GET' &&
            method !== 'HEAD' &&
            hooks.type !== 'none' &&
            (!!validator.body ||
