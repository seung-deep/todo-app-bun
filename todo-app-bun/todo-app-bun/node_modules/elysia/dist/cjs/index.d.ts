...
export default class Elysia<BasePath extends string = '', Decorators extends DecoratorBase = {
    ...
    type: {};
    error: {};
}, ParentSchema extends RouteSchema = {}, Routes extends RouteBase = {}, Scoped extends boolean = false> {
     ...
     * ```
     */
    onTransform<Schema extends RouteSchema = {}>(handler: MaybeArray<VoidHandler<MergeSchema<Schema, ParentSchema>, Decorators>>): this;
    /**
    ...
    group<const LocalSchema extends InputSchema<Extract<keyof Definitions['type'], string>>, const NewElysia extends Elysia<any, any, any, any, any, any>, const Prefix extends string, const Schema extends MergeSchema<UnwrapRoute<LocalSchema, Definitions['type']>, ParentSchema>>(prefix: Prefix, schema: LocalHook<LocalSchema, Schema, Decorators, Definitions['error'], `${BasePath}${Prefix}`>, run: (group: Elysia<`${BasePath}${Prefix}`, Decorators, Definitions, Schema, {}>) => NewElysia): NewElysia extends Elysia<any, infer PluginDecorators, infer PluginDefinitions, infer PluginSchema, any> ? Elysia<BasePath, Prettify<Decorators & PluginDecorators>, {
    ...
    use<NewElysia extends Elysia<any, any, any, any, any, any> = this>(plugin: MaybePromise<(app: NewElysia) => MaybePromise<NewElysia>>): NewElysia extends Elysia<any, infer PluginDecorators, infer PluginDefinitions, infer PluginSchema, any> ? Elysia<BasePath, {
        ...
        type: Prettify<Definitions['type'] & PluginDefinitions['type']>;
        error: Prettify<Definitions['error'] & PluginDefinitions['error']>;
    }, Prettify<MergeSchema<ParentSchema, PluginSchema>>, Routes & NewElysia['schema'], Scoped> : this;
    use<NewElysia extends Elysia<any, any, any, any, any, any>>(instance: MaybePromise<NewElysia>): NewElysia extends Elysia<any, infer PluginDecorators, infer PluginDefinitions, infer PluginSchema, any, infer IsScoped> ? IsScoped extends true ? this : Elysia<BasePath, {
        request: Prettify<Decorators['request'] & PluginDecorators['request']>;
        store: Prettify<Decorators['store'] & PluginDecorators['store']>;
    }, {
        type: Prettify<Definitions['type'] & PluginDefinitions['type']>;
        error: Prettify<Definitions['error'] & PluginDefinitions['error']>;
    }, Prettify<MergeSchema<ParentSchema, PluginSchema>>, BasePath extends `` ? Routes & NewElysia['schema'] : Routes & AddPrefix<BasePath, NewElysia['schema']>, Scoped> : this;
    use<NewElysia extends Elysia<any, any, any, any, any, any>>(plugin: Promise<{
        default: (elysia: Elysia<any, any, any, any, any, any>) => MaybePromise<NewElysia>;
    }>): NewElysia extends Elysia<any, infer PluginDecorators, infer PluginDefinitions, infer PluginSchema, any> ? Elysia<BasePath, {
    ...
    }, MergeSchema<ParentSchema, PluginSchema>, BasePath extends `` ? Routes & NewElysia['schema'] : Routes & AddPrefix<BasePath, NewElysia['schema']>, Scoped> : this;
    use<LazyLoadElysia extends Elysia<any, any, any, any, any, any>>(plugin: Promise<{
        default: LazyLoadElysia;
    }>): LazyLoadElysia extends Elysia<any, infer PluginDecorators, infer PluginDefinitions, infer PluginSchema, any> ? Elysia<BasePath, {
    ...
    }, MergeSchema<PluginSchema, ParentSchema>, BasePath extends `` ? Routes & LazyLoadElysia['schema'] : Routes & AddPrefix<BasePath, LazyLoadElysia['schema']>> : this;
    private _use;
    ...
    }, Definitions, ParentSchema, Routes, Scoped>;
    /**
     * ### state
     * Assign global mutatable state accessible for all handler
     *
